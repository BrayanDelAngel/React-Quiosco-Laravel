        ...
        <div >
            ...
            <div className="grid grid-cols-2 gap-5">
                {data.data.data.map(pedido => (
                    <div key={pedido.id} className="p-5 bg-white shadow-lg space-y-2 border-b-2">
                        ...
                        <p className="text-lg font-bold text-slate-600 gap-2">
                            Cliente:{' '}
                            <span className="font-normal">
                                {pedido.user.name}
                            </span>
                        </p>
                        <p className="text-lg font-bold text-amber-500 gap-2">
                            Total:{' '}
